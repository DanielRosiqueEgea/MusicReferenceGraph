...
# Intentar importar las claves desde el módulo Api_keys
    try:
        from Api_keys import client_id_Spoty, client_secret_spoty
        ...
        if total_args == 3:
            ...
            client_id_Spoty = sys.argv[1]
            client_secret_spoty = sys.argv[2]
    ...
    return client_id_Spoty, client_secret_spoty
...
# client_id_Spoty = input("Introduce tu id de cliente Spotify: ")
# client_secret_spoty = input("Introduce tu clave secreta de cliente Spotify: ")
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id=client_id_Spoty,
                                                           client_secret=client_secret_spoty))
